...
//	for (i=0;i<sfsize;i++){ spinor_field_copy_to_gpu_f(&sf1[i]); }
	...
	res_gpu_opt = spinor_field_prod_re_opt_f_flt(&sf1[0],&sf1[1]);
...
//	for (i=0;i<sfsize;i++){ spinor_field_copy_to_gpu_f(&sf1[i]); }
	...
	res_gpu_opt = spinor_field_prod_im_opt_f_flt(&sf1[0],&sf1[1]);
	lprintf("TEST",0,"Check spinor_field_prod_im\n gpu=%1.10g, cpu=%1.10g, opt=%1.10g, \n opt-cpu= %1.10g\n\n",res_gpu,res_cpu,res_gpu_opt,res_gpu_opt-res_cpu);
	
	//Check spinor_field_prod
//	for (i=0;i<sfsize;i++){ spinor_field_copy_to_gpu_f(&sf1[i]); }
	c_res_gpu = spinor_field_prod_f_flt(&sf1[0],&sf1[1]);
	c_res_cpu = spinor_field_prod_f_flt_cpu(&sf1[0],&sf1[1]);
	c_res_gpu_opt = spinor_field_prod_opt_f_flt(&sf1[0],&sf1[1]);
...
//	for (i=0;i<sfsize;i++){ spinor_field_copy_to_gpu_f(&sf1[i]); }
	...
	res_gpu_opt = spinor_field_g5_prod_re_opt_f_flt(&sf1[0],&sf1[1]);
...
//	for (i=0;i<sfsize;i++){ spinor_field_copy_to_gpu_f(&sf1[i]); }
	...
	res_gpu_opt = spinor_field_g5_prod_im_opt_f_flt(&sf1[0],&sf1[1]);
...
//	for (i=0;i<sfsize;i++){ spinor_field_copy_to_gpu_f(&sf1[i]); }
	...
	res_gpu_opt = spinor_field_sqnorm_opt_f_flt(&sf1[0]);
