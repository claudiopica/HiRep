...
//	res_gpu = spinor_field_prod_re_f_flt(&sf1[0],&sf1[1]);
	...
	res_gpu_opt = spinor_field_prod_re_f_flt(&sf1[0],&sf1[1]);
...
//	res_gpu = spinor_field_prod_im_f_flt(&sf1[0],&sf1[1]);
	...
	res_gpu_opt = spinor_field_prod_im_f_flt(&sf1[0],&sf1[1]);
...
//	c_res_gpu = spinor_field_prod_f_flt(&sf1[0],&sf1[1]);
	...
	c_res_gpu_opt = spinor_field_prod_f_flt(&sf1[0],&sf1[1]);
...
//	res_gpu = spinor_field_g5_prod_re_f_flt(&sf1[0],&sf1[1]);
	...
	res_gpu_opt = spinor_field_g5_prod_re_f_flt(&sf1[0],&sf1[1]);
...
//	res_gpu = spinor_field_g5_prod_im_f_flt(&sf1[0],&sf1[1]);
	...
	res_gpu_opt = spinor_field_g5_prod_im_f_flt(&sf1[0],&sf1[1]);
...
//	res_gpu = spinor_field_sqnorm_f_flt(&sf1[0]);
	...
	res_gpu_opt = spinor_field_sqnorm_f_flt(&sf1[0]);
