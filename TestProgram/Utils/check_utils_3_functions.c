...
if(3==rotid){
 tmp[0]=rotfun(2) + 0.5*unrotfun(2) + 0.8660254037844386*unrotfun(4);
 _complex_mul_star(tmp[1],tmp[0],tmp[0]);
 if(sqrt(creal(tmp[1]))>1.e-12) {
return_value++;
 }
...
if(3==rotid){
 tmp[0]=rotfun(4) + 0.8660254037844386*unrotfun(2) - 0.5*unrotfun(4);
 _complex_mul_star(tmp[1],tmp[0],tmp[0]);
 if(sqrt(creal(tmp[1]))>1.e-12) {
return_value++;
 }
...
if(3==rotid){
 tmp[0]=rotfun(3) + 0.5*unrotfun(3) + 0.8660254037844386*unrotfun(5);
 _complex_mul_star(tmp[1],tmp[0],tmp[0]);
 if(sqrt(creal(tmp[1]))>1.e-12) {
return_value++;
 }
...
if(3==rotid){
 tmp[0]=rotfun(5) + 0.8660254037844386*unrotfun(3) - 0.5*unrotfun(5);
 _complex_mul_star(tmp[1],tmp[0],tmp[0]);
 if(sqrt(creal(tmp[1]))>1.e-12) {
return_value++;
 }
