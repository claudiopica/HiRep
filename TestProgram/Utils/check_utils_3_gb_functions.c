...
_complex_mul_star(tmp[2],tmp[0]-tmp[1],tmp[0]-tmp[1]);
if(sqrt(creal(tmp[2]))>=1.e-10){
  lprintf("Error",0," Op=8 Pre[ax, ax, ay, -ax, -ax, -ay][0, 0, 0] - 8 Pre[ax, ax, az, -ax, -ax, -az][0, 0, 0] - 8 Pre[ay, ay, ax, -ay, -ay, -ax][0, 0, 0] + 8 Pre[ay, ay, az, -ay, -ay, -az][0, 0, 0] + 8 Pre[az, az, ax, -az, -az, -ax][0, 0, 0] - 8 Pre[az, az, ay, -az, -az, -ay][0, 0, 0]\n px=%d py=%d pz=%d Irrep=%d ev=%d charge=%d multiplet id=%d (%2.10e %2.10e) (%2.10e %2.10e) %2.10e \n",0,0,0,2,1,1,1,creal(tmp[0]),cimag(tmp[0]),creal(tmp[1]),cimag(tmp[1]),sqrt(creal(tmp[2])));
  return_value++;
  }
}
if(1==rotid)
...
_complex_mul_star(tmp[2],tmp[0]-tmp[1],tmp[0]-tmp[1]);
if(sqrt(creal(tmp[2]))>=1.e-10){
  lprintf("Error",0," Op=(-8 I) Pim[ax, ax, az, -ax, -ax, -az][0, 0, 0] - 8 Pim[ay, ay, az, -ay, -ay, -az][0, 0, 0] + (8 I) Pim[az, az, ax, -az, -az, -ax][0, 0, 0] + 8 Pim[az, az, ay, -az, -az, -ay][0, 0, 0]\n px=%d py=%d pz=%d Irrep=%d ev=%d charge=%d multiplet id=%d (%2.10e %2.10e) (%2.10e %2.10e) %2.10e \n",0,0,0,4,1,-1,1,creal(tmp[0]),cimag(tmp[0]),creal(tmp[1]),cimag(tmp[1]),sqrt(creal(tmp[2])));
  return_value++;
  }
}
if(0==rotid)
...
_complex_mul_star(tmp[2],tmp[0]-tmp[1],tmp[0]-tmp[1]);
if(sqrt(creal(tmp[2]))>=1.e-10){
  lprintf("Error",0," Op=8 Sqrt[2] Pim[ax, ax, ay, -ax, -ax, -ay][0, 0, 0] - 8 Sqrt[2] Pim[ay, ay, ax, -ay, -ay, -ax][0, 0, 0]\n px=%d py=%d pz=%d Irrep=%d ev=%d charge=%d multiplet id=%d (%2.10e %2.10e) (%2.10e %2.10e) %2.10e \n",0,0,0,4,2,-1,1,creal(tmp[0]),cimag(tmp[0]),creal(tmp[1]),cimag(tmp[1]),sqrt(creal(tmp[2])));
  return_value++;
  }
}
if(0==rotid)
...
{
tmp[0]=rotfun(8);
tmp[1]=Complex(0.,-0.5)*unrotfun(8) - Complex(0.,0.7071067811865475)*unrotfun(9) - Complex(0.,0.5)*unrotfun(10);
_complex_mul_star(tmp[2],tmp[0]-tmp[1],tmp[0]-tmp[1]);
if(sqrt(creal(tmp[2]))>=1.e-10){
  lprintf("Error",0," Op=(-8 I) Pim[ax, ax, az, -ax, -ax, -az][0, 0, 0] - 8 Pim[ay, ay, az, -ay, -ay, -az][0, 0, 0] + (8 I) Pim[az, az, ax, -az, -az, -ax][0, 0, 0] + 8 Pim[az, az, ay, -az, -az, -ay][0, 0, 0]\n px=%d py=%d pz=%d Irrep=%d ev=%d charge=%d multiplet id=%d (%2.10e %2.10e) (%2.10e %2.10e) %2.10e \n",0,0,0,4,1,-1,1,creal(tmp[0]),cimag(tmp[0]),creal(tmp[1]),cimag(tmp[1]),sqrt(creal(tmp[2])));
  return_value++;
