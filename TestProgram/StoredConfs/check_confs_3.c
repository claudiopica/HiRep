...
int main(int argc, char *argv[])
{
  ...
  test = fabs(1. - 2 * VOLUME * tavg[0] / openQCDWFobsl0[0]);
  ...
  test = fabs(1. - 2 * VOLUME * tavg[1] / openQCDWFobsl0[1]);
  ...
  test = fabs(1. - 2 * VOLUME * tavg[0] / openQCDWFobsl2[0]);
  ...
  test = fabs(1. - 2 * VOLUME * tavg[1] / openQCDWFobsl2[1]);
