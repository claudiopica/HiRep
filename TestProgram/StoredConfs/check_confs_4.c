...
double openQCDWsl0[8] = { 2.1909123450308125e+03, 2.9722361042026669e+03, 3.0259644616131136e+03, 3.0367303385187884e+03,
                          3.0300970965090023e+03, 2.9649859783298034e+03, 2.9359214984384339e+03, 2.2052896618928303e+03 };

double openQCDWsl2[8] = { 2.6765320194413977e+02, 4.3236116872750966e+02, 5.0381778362571441e+02, 5.4540524750120494e+02,
                          5.3406739744445190e+02, 4.9821098379050790e+02, 4.4323964021188277e+02, 2.6762499410912039e+02 };

double openQCDYsl0[8] = { 0.0000000000000000e+00, 5.9997765048648591e+02, 6.1282361881016141e+02, 6.3095249267986230e+02,
                          6.1822993203120677e+02, 6.0704066139211864e+02, 5.9840893154888931e+02, 0.0000000000000000e+00 };

double openQCDYsl2[8] = { 0.0000000000000000e+00, 2.0686068189329623e+02, 2.4733137411699627e+02, 2.7787571681954273e+02,
                          2.7083362437002722e+02, 2.4972541162443318e+02, 2.1416235919599703e+02, 0.0000000000000000e+00 };
...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < GLB_T; i++) {
        ...
        if (fabs(comb[0]) > 1.e-16) { test += fabs((comb[0] - openQCDWsl0[i]) / comb[0]); }
        if (fabs(comb[1]) > 1.e-16) { test += fabs((comb[1] - openQCDWsl2[i]) / comb[1]); }
        ...
        if (fabs(comb[0]) > 1.e-16) { test += fabs((comb[0] - openQCDYsl0[i]) / comb[0]); }
        if (fabs(comb[1]) > 1.e-16) { test += fabs((comb[1] - openQCDYsl2[i]) / comb[1]); }
    }
