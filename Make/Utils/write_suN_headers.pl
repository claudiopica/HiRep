...
write_upper_spinor_prod_re();
write_upper_spinor_prod_re_assign();
write_lower_spinor_prod_re();
write_lower_spinor_prod_re_assign();
...
sub write_upper_spinor_prod_re {
  print "/* z=re(r0*s0+r1*s1) (r,s spinors, z real) */\n";
  print "#define _spinor_upper_prod_re_${suff}(z,r,s) \\\n";	
  	print "   do { \\\n";
	print "      (z)=0.; \\\n";
  for (my $k=0; $k<2; $k++){
    print "      _vector_prod_add_assign_re_${suff}((z),(r).$cname\[$k\],(s).$cname\[$k\])";
    if($k==1) {print"; \\\n   } while(0) \n\n";} else {print "; \\\n"}
  }
}
sub write_lower_spinor_prod_re {
  print "/* z=re(r2*s2+r3*s3) (r,s spinors, z real) */\n";
  print "#define _spinor_lower_prod_re_${suff}(z,r,s) \\\n";	
  	print "   do { \\\n";
	print "      (z)=0; \\\n";
  for (my $k=2; $k<4; $k++){
    print "      _vector_prod_add_assign_re_${suff}((z),(r).$cname\[$k\],(s).$cname\[$k\])";
...
sub write_upper_spinor_prod_re_assign {
  print "/* z+=re(r0*s0+r1*s1) (r,s spinors, z real) */\n";
  print "#define _spinor_upper_prod_re_assign_${suff}(z,r,s) \\\n";	
  	print "   do { \\\n";
  for (my $k=0; $k<2; $k++){
    print "      _vector_prod_add_assign_re_${suff}((z),(r).$cname\[$k\],(s).$cname\[$k\])";
    if($k==1) {print"; \\\n   } while(0) \n\n";} else {print "; \\\n"}
...
sub write_lower_spinor_prod_re_assign {
  print "/* z+=re(r2*s2+r3*s3) (r,s spinors, z real) */\n";
  print "#define _spinor_lower_prod_re_assign_${suff}(z,r,s) \\\n";	
  	print "   do { \\\n";
  for (my $k=2; $k<4; $k++){
    print "      _vector_prod_add_assign_re_${suff}((z),(r).$cname\[$k\],(s).$cname\[$k\])";
    if($k==3) {print"; \\\n   } while(0) \n\n";} else {print "; \\\n"}
