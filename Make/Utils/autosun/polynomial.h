...
public:
    ...
    friend bool operator<(const rmonomial &a, const rmonomial &b) {
...
public:
    ...
    string str_real() const {
        ...
        for (KEYTYPE i = 0; i < length; i++) {
            ...
            if (!equal(a, 0.0) && !equal(a, data[i]->value.re) && !equal(a, -data[i]->value.re)) {
                a = 1.0;
            } else {
                a = data[i]->value.re;
            }
    ...
    string str_imag() const {
        ...
        for (KEYTYPE i = 0; i < length; i++) {
            ...
            if (!equal(a, 0.0) && !equal(a, data[i]->value.im) && !equal(a, -data[i]->value.im)) {
                a = 1.0;
            } else {
                a = data[i]->value.im;
            }
