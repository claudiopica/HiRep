...
#define _PERFORMANCE_REACHED(_bandwidth) \
    do { \
        ...
        lprintf("RESULT", 0, "Peak Memory Bandwidth: %1.6g GB/s, " \
                             "Performance reached: %0.2f \%\n", \
                             peak_memory_bandwidth, \
                             _bandwidth / peak_memory_bandwidth); \
    } while (0);
...
int main(int argc, char* argv[]) {
    ...
    _SPEED_TEST_LIN_ALG_FLT("Square norm single precision", 1, 0, NF*4*2, in_flt, 
