...
__host__ __device__ hr_complex_int operator+(const int x, const hr_complex_int &c);
__host__ __device__ hr_complex_int operator+(const float x, const hr_complex_int &c);
__host__ __device__ hr_complex_int operator+(const double x, const hr_complex_int &c);
__host__ __device__ hr_complex_int operator-(const int x, const hr_complex_int &c);
__host__ __device__ hr_complex_int operator-(const float x, const hr_complex_int &c);
__host__ __device__ hr_complex_int operator-(const double x, const hr_complex_int &c);
__host__ __device__ hr_complex_int operator*(const int x, const hr_complex_int &c);
...
__host__ __device__ hr_complex_int operator/(const float x, const hr_complex_int &c);
__host__ __device__ hr_complex_int operator/(const double x, const hr_complex_int &c);
__host__ __device__ hr_complex_flt operator+(const int x, const hr_complex_flt &c);
__host__ __device__ hr_complex_flt operator+(const float x, const hr_complex_flt &c);
__host__ __device__ hr_complex_flt operator+(const double x, const hr_complex_flt &c);
__host__ __device__ hr_complex_flt operator+(const hr_complex_int &x, const hr_complex_flt &c);
__host__ __device__ hr_complex_flt operator-(const int x, const hr_complex_flt &c);
__host__ __device__ hr_complex_flt operator-(const float x, const hr_complex_flt &c);
__host__ __device__ hr_complex_flt operator-(const double x, const hr_complex_flt &c);
__host__ __device__ hr_complex_flt operator-(const hr_complex_int &x, const hr_complex_flt &c);
...
__host__ __device__ hr_complex_flt operator/(const double x, const hr_complex_flt &c);
__host__ __device__ hr_complex_flt operator/(const hr_complex_int &x, const hr_complex_flt &c);
__host__ __device__ hr_complex operator+(const int x, const hr_complex &c);
__host__ __device__ hr_complex operator+(const float x, const hr_complex &c);
__host__ __device__ hr_complex operator+(const double x, const hr_complex &c);
__host__ __device__ hr_complex operator+(const hr_complex_int &x, const hr_complex &c);
__host__ __device__ hr_complex operator+(const hr_complex_flt &x, const hr_complex &c);
__host__ __device__ hr_complex operator-(const int x, const hr_complex &c);
__host__ __device__ hr_complex operator-(const float x, const hr_complex &c);
__host__ __device__ hr_complex operator-(const double x, const hr_complex &c);
__host__ __device__ hr_complex operator-(const hr_complex_int &x, const hr_complex &c);
