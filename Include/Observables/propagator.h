...
#define _propagator_assign_spin_matrix(r, s, i) (r).c[i] = (s)
        ...
        for (_alpha = 0; _alpha < NF; ++_alpha) {                                                                \
            for (_a = 0; _a < NF; ++_a) {                                                                        \
                for (_beta = 0; _beta < NF; ++_beta) {                                                           \
                    for (_b = 0; _b < NF; ++_b) {                                                                \
                        _complex_mul_assign((s).c[(_alpha)].c[(_a)], (r).c[(_a)].c[(_alpha)].c[(_beta)].c[(_b)], \
                                            (t).c[(_beta)].c[(_b)]);                                             \
                    }                                                                                            \
                }                                                                                                \
            }                                                                                                    \
    ...
    do {                                                                                          \
        ...
        for (_beta = 0; _beta < NF; ++_beta) {                                                    \
            for (_b = 0; _b < NF; ++_b) {                                                         \
                for (_alpha = 0; _alpha < NF; ++_alpha) {                                         \
                    for (_a = 0; _a < NF; ++_a) {                                                 \
                        _complex_mul_star_assign((s).c[(_beta)].c[(_b)], (t).c[(_alpha)].c[(_a)], \
                    ...
                    for (_beta = 0; _beta < 4; ++_beta) {                                                                \
                        ...
                        for (_c = 0; _c < NF; _c++) {                                                                    \
                            for (_gamma = 0; _gamma < 4; _gamma++) {                                                     \
                                _complex_mul_assign(Q.c[_a].c[_alpha].c[_beta].c[_b], S.c[_a].c[_alpha].c[_gamma].c[_c], \
