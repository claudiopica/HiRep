...
int HBiCGstab_mshift(mshift_par *par, spinor_operator M, spinor_field *in, spinor_field *out){
  ...
  */
   ...
   error(in->type!=&glattice,1,"HBiCGstab_mshift [HBiCGstab_mshift.c]", "Spinors don't match!");
   error(out->type!=&glattice,1,"HBiCGstab_mshift [HBiCGstab_mshift.c]", "Spinors don't match!");
