...
The case of the determinatn $\det{ Q_m (W_- 
 W_+)^{-1} Q_m }$  can be
recovered by setting $\mu_1=0$ in the following equations.

We have :
\begin{equation}
(Q_m-i\mu_1)^{-1} W_- W_+ (Q_m+i\mu_1)^{-1} = ( 1 - i(\mu_2 - \mu_1)
Q_m^{-1}) (1+ i(\mu_2 - \mu_1) Q_m^{-1})) 
\end{equation}

The force can then be computed :
\begin{eqnarray}
 \dot{\mathcal{H}_{F_2}}  &=& - i(\mu_2-\mu_1) \phi_2^{\dagger} \left[ ( 1 - i(\mu_2 - \mu_1) 
  Q_m^{-1}) \dot{Q_m^{-1}}  - \dot{Q_m^{-1}} (1+ i (\mu_2 - \mu_1) Q_m^{-1})\right] \phi_2 \\
