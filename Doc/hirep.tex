...
\begin{equation}
X\equiv Q_m^{-1}\phi_2,\quad\textrm{and}\quad Y^{\dagger}=\phi_2^\dagger
(1+ \mu Q^{-1}) Q_m^{-1}
\end{equation}

From which we deduce 
\begin{equation}
Y =   Q_m^{-1}(1 + \mu Q^{-1})  \phi_2 =  D^{-1}  \gamma_5( \phi_2  +
\mu  X)  
\end{equation}
\bibliography{hirep}
