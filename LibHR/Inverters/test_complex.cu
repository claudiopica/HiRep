...
int test_overload_plus_rhs_double(){
    ...
    if (abs(2.2 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  c.re) > pow(10, -6)){
        result += int(pow(10, 2));
    }
    if (abs(2.2 -  c.im) > pow(10, -6)){
        result += int(pow(10, 3));
    }
    if (abs(3.3 -  b) > pow(10, -6)){
        result += int(pow(10, 4));
    }
    return result;
}
...
int test_overload_prod_rhs_double(){
    ...
    double b = 3.3;
    a = c*b;
    if (abs(3.63 -  a.re) > pow(10, -6)){
        result += int(pow(10, 0));
    }
    if (abs(7.26 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  c.re) > pow(10, -6)){
        result += int(pow(10, 2));
...
int test_overload_div_rhs_double(){
    ...
    double b = 3.3;
    a = c/b;
    if (abs(1.0/3.0 -  a.re) > pow(10, -6)){
        result += int(pow(10, 0));
    }
    if (abs(2.0/3.0 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  c.re) > pow(10, -6)){
        result += int(pow(10, 2));
...
int test_overload_div_lhs_double(){
    ...
    double b = 3.3;
    a = b/c;
    if (abs(0.6 -  a.re) > pow(10, -6)){
        result += int(pow(10, 0));
    }
    if (abs(-1.2 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  c.re) > pow(10, -6)){
        result += int(pow(10, 2));
...
int test_overload_plus_hr_complex(){
    ...
    if (abs(3.3 -  b.re) > pow(10, -6)){
        result += int(pow(10, 4));
    }
    if (abs(4.4 -  b.im) > pow(10, -6)){
        result += int(pow(10, 5));
    }
    return result;
}
...
int test_overload_prod_hr_complex(){
    ...
    hr_complex a;
    a = b*c;
    if (abs(-6.05 -  a.re) > pow(10, -6)){
        result += int(pow(10, 0));
    }
    if (abs(12.1 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  c.re) > pow(10, -6)){
        result += int(pow(10, 2));
...
int test_negate(){
    ...
    hr_complex a;
    a = -b;
    if (abs(-1.1 -  a.re) > pow(10, -6)){
        result += int(pow(10, 0));
    }
    if (abs(-2.2 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  b.re) > pow(10, -6)){
        result += int(pow(10, 2));
    }
    if (abs(2.2 -  b.im) > pow(10, -6)){
        result += int(pow(10, 3));
    }
    return result;
}
...
int test_cast_double(){
    ...
    if (abs(0.0 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  b) > pow(10, -6)){
        result += int(pow(10, 2));
    }
    return result;
}
...
int test_overload_plus_rhs_integer(){
    ...
    a = c + b;
    if (abs(4.1 -  a.re) > pow(10, -6)){
        result += int(pow(10, 0));
    }
    if (abs(6.2 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  c.re) > pow(10, -6)){
        result += int(pow(10, 2));
    ...
    if (abs(3 -  b.re) > pow(10, -6)){
        result += int(pow(10, 4));
    }
    if (abs(4 -  b.im) > pow(10, -6)){
        result += int(pow(10, 5));
    }
    return result;
}
...
int test_overload_div_rhs_integer(){
    ...
    hr_complex a;
    a = c/b;
    if (abs(0.484 -  a.re) > pow(10, -6)){
        result += int(pow(10, 0));
    }
    if (abs(0.088 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  c.re) > pow(10, -6)){
        result += int(pow(10, 2));
...
int test_overload_div_lhs_integer(){
    ...
    hr_complex a;
    a = b/c;
    if (abs(2.0 -  a.re) > pow(10, -6)){
        result += int(pow(10, 0));
    }
    if (abs(-4.0/11.0 -  a.im) > pow(10, -6)){
        result += int(pow(10, 1));
    }
    if (abs(1.1 -  c.re) > pow(10, -6)){
        result += int(pow(10, 2));
...
int test_I_prod(){
    ...
    if (abs(-2.2 -  b.re) > pow(10, -6)){
        result += int(pow(10, 2));
    }
    if (abs(1.1 -  b.im) > pow(10, -6)){
        result += int(pow(10, 3));
    }
    return result;
}
