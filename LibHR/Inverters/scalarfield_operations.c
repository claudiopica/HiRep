...
void set_scalar_field(scalar_field *s, double c) {
    error(s == NULL, 1, "set_scalar_field [scalarfield_operations.c]", "Attempt to access unallocated memory space");
...
void gaussian_scalar_field(scalar_field *s) {
    error(s == NULL, 1, "gaussian_scalar_field [scalarfield_operations.c]", "Attempt to access unallocated memory space");
