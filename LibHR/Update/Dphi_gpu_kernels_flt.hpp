                                        ...
                                        const int block_start_iyp) 
{
  ...
  if (local_ix < vol4h) {
    ...
    inner_direction(_T_plus_flt,  T_UP_MASK, ix, iup_d, 4*ix);
    inner_direction(_T_minus_flt, T_DN_MASK, ix, idn_d, 4*ix);
    inner_direction(_X_plus_flt,  X_UP_MASK, ix, iup_d, 4*ix+1);
    inner_direction(_X_minus_flt, X_DN_MASK, ix, idn_d, 4*ix+1);
    inner_direction(_Y_plus_flt,  Y_UP_MASK, ix, iup_d, 4*ix+2);
    inner_direction(_Y_minus_flt, Y_DN_MASK, ix, idn_d, 4*ix+2);
    inner_direction(_Z_plus_flt,  Z_UP_MASK, ix, iup_d, 4*ix+3);
    inner_direction(_Z_minus_flt, Z_DN_MASK, ix, idn_d, 4*ix+3);
                            ...
                            const int start, const int start_piece)
{
  ...
  if (local_ix < vol4h) {
    ...
    __syncthreads();
    boundary_calculation(_T_plus_flt,  T_UP_MASK, ix, iup_d, 4*ix);
    boundary_calculation(_T_minus_flt, T_DN_MASK, ix, idn_d, 4*ix);
    boundary_calculation(_X_plus_flt,  X_UP_MASK, ix, iup_d, 4*ix+1);
    boundary_calculation(_X_minus_flt, X_DN_MASK, ix, idn_d, 4*ix+1);
    boundary_calculation(_Y_plus_flt,  Y_UP_MASK, ix, iup_d, 4*ix+2);
    boundary_calculation(_Y_minus_flt, Y_DN_MASK, ix, idn_d, 4*ix+2);
    boundary_calculation(_Z_plus_flt,  Z_UP_MASK, ix, iup_d, 4*ix+3);
    boundary_calculation(_Z_minus_flt, Z_DN_MASK, ix, idn_d, 4*ix+3);
