...
#define _T_plus_flt(__read_stride, __write_stride) \
      read_gpu_suNf_vector_flt(__read_stride, sn.c[0], in, local_iy, 0, 1); \
      read_gpu_suNf_vector_flt(__read_stride, sn.c[1], in, local_iy, 2, 1); \
      read_gpu_suNf_flt(__write_stride, u, gauge_ixp, local_ix, 0, 4); \
\
...
\
      read_gpu_suNf_vector_flt(__read_stride, sn.c[0], in, local_iy, 1, 1); \
      read_gpu_suNf_vector_flt(__read_stride, sn.c[1], in, local_iy, 3, 1); \
      _vector_add_assign_f(sn.c[0], sn.c[1]); \
\
      _suNf_theta_T_multiply(sn.c[1], u, sn.c[0]); \
\
...
#define _T_minus_flt(__read_stride, __write_stride) \
    read_gpu_suNf_vector_flt(__read_stride, sn.c[0], in, local_iy, 0, 1); \
    read_gpu_suNf_vector_flt(__read_stride, sn.c[1], in, local_iy, 2, 1); \
    read_gpu_suNf_flt(__read_stride, u, gauge_iyp, local_iy, 0, 4); \
\
...
#define _X_plus_flt(__read_stride, __write_stride) \
      read_gpu_suNf_vector_flt(__read_stride, sn.c[0], in, local_iy, 0, 1); \
      read_gpu_suNf_vector_flt(__read_stride, sn.c[1], in, local_iy, 3, 1); \
      read_gpu_suNf_flt(__write_stride, u, gauge_ixp, local_ix, 1, 4); \
\
...
#define _X_minus_flt(__read_stride, __write_stride) \
      read_gpu_suNf_vector_flt(__read_stride, sn.c[0], in, local_iy, 0, 1); \
      read_gpu_suNf_vector_flt(__read_stride, sn.c[1], in, local_iy, 3, 1); \
      read_gpu_suNf_flt(__read_stride, u, gauge_iyp, local_iy, 1, 4); \
\
...
#define _Y_plus_flt(__read_stride, __write_stride) \
      ...
      _vector_add_assign_f(sn.c[0], sn.c[1]); \
\
      read_gpu_suNf_flt(__write_stride, u, gauge_ixp, local_ix, 2, 4); \
...
#define _Y_minus_flt(__read_stride, __write_stride) \
      ...
      _vector_sub_assign_f(sn.c[0], sn.c[1]); \
\
      read_gpu_suNf_flt(__read_stride, u, gauge_iyp, local_iy, 2, 4); \
...
#define _Z_plus_flt(__read_stride, __write_stride) \
      ...
      _vector_i_add_assign_f(sn.c[0], sn.c[1]); \
\
      read_gpu_suNf_flt(__write_stride, u, gauge_ixp, local_ix, 3, 4); \
...
#define _Z_minus_flt(__read_stride, __write_stride) \
      ...
      _vector_i_sub_assign_f(sn.c[0], sn.c[1]); \
\
      read_gpu_suNf_flt(__read_stride, u, gauge_iyp, local_iy, 3, 4); \
