...
void init_pure_gauge_anisotropy(double *chi) {
    ...
    error(plaq_weight == NULL, 0, "init_pure_gauge_anisotropy",
          "In order to use anisotropic lattice you must compile with PLAQ_WEIGHTS enabled");
...
#else
    error(0 == 0, 0, "init_pure_gauge_anisotropy",
