...
void rlxs_reset(int state[]) {
    ...
    if (state[0] != rlxs_size()) { local_error(5); }
    ...
    if (((pr != 109) && (pr != 202) && (pr != 397)) || (ir < 0) || (ir > 11) || (jr < 0) || (jr > 11) ||
        (jr != ((ir + 7) % 12)) || (is < 0) || (is > 95)) {
        local_error(5);
    }
}
...
void rlxs_init(int level, int seed) {
    _OMP_PRAGMA(_omp_parallel) {
        ...
        if ((INT_MAX < 2147483647) || (FLT_RADIX != 2) || (FLT_MANT_DIG < 24)) { local_error(0); }
...
void rlxs_reset(int state[]) {
    ...
    if ((INT_MAX < 2147483647) || (FLT_RADIX != 2) || (FLT_MANT_DIG < 24)) { local_error(4); }
    ...
    if (((pr[tid] != 109) && (pr[tid] != 202) && (pr[tid] != 397)) || (ir[tid] < 0) || (ir[tid] > 11) || (jr[tid] < 0) ||
        (jr[tid] > 11) || (jr[tid] != ((ir[tid] + 7) % 12)) || (is[tid] < 0) || (is[tid] > 95)) {
        local_error(5);
    }
}
#else
