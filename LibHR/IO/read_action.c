    ...
    for (int i = 0; i < n_mon; i++) {
        ...
        if (strcmp(type, "gauge") == 0) {
            ...
            lprintf("ACTION", 10, "Monomial %d: level = %d, type = hmc, mass = %1.6f, force_prec = %1.2e, mt_prec = %1.2e\n", i,
                    level, par->mass, data.force_prec, data.MT_prec);
            ...
            // Monomial information
            lprintf("ACTION", 10,
                    "Monomial %d: level = %d, type = tm, mass = %1.6f, mu = %1.6f, force_prec = %1.2e, mt_prec = %1.2e\n", i,
                    level, par->mass, par->mu, data.force_prec, data.MT_prec);
            ...
            // Monomial information
            lprintf("ACTION", 10,
                    "Monomial %d: level = %d, type = tm_alt, mass = %1.6f, mu = %1.6f, force_prec = %1.2e, mt_prec = %1.2e\n",
            ...
            lprintf(
                "ACTION", 10,
                "Monomial %d: level = %d, type = hasenbusch, mass = %1.6f, dm = %1.6f, force_prec = %1.2e, mt_prec = %1.2e\n",
            ...
            lprintf(
                "ACTION", 10,
                "Monomial %d: level = %d, type = rhmc, mass = %1.6f, force_prec = %1.2e, mt_prec = %1.2e, md_prec = %1.2e\n", i,
                level, par->mass, data.force_prec, data.MT_prec, data.MD_prec);
            ...
            lprintf(
                "ACTION", 10,
                "Monomial %d: level = %d, type = hasenbusch_tm, mass = %1.6f, mu = %1.6f, dmu = %1.6f, force_prec = %1.2e, mt_prec = %1.2e\n",
            ...
            lprintf(
                "ACTION", 10,
                "Monomial %d: level = %d, type = hasenbusch_tm_alt, mass = %1.6f, mu = %1.6f, dmu = %1.6f, force_prec = %1.2e, mt_prec = %1.2e\n",
                i, level, par->mass, par->mu, par->dmu, data.force_prec, data.MT_prec);
        ...
        } else if (strcmp(type, "hasenbusch_ff") == 0) // hasenbusch term for fermions with four fermion interaction
        {
            ...
            lprintf(
                "ACTION", 10,
                "Monomial %d: level = %d, type = hasenbusch_ff, mass = %1.6f, dm = %1.6f, force_prec = %1.2e, mt_prec = %1.2e\n",
                i, level, par->mass, par->dm, data.force_prec, data.MT_prec);
...
void read_action(char *filename, integrator_par **ip_ptr) {
    ...
    if (fp == NULL) { check(1, "Unable to open file\n"); }
