...
char *meson_channel_names[NGAMMA_IND] = { "g5",   "id",   "g0",   "g1",   "g2",   "g3",     "g0g1",   "g0g2",
...
static double determine_sign(gamma_ind ind) {
    if (ind == _g5 || ind == _g0 || ind == _g1 || ind == _g3 || ind == _g0g1 || ind == _g0g3 || ind == _g0g5 || ind == _g5g1 ||
        ind == _g5g3 || ind == _g0g5g2) {
        return -1.;
    } else {
        return 1.;
    }
...
static void add_meson_observable(meson_observable **mop, gamma_ind ind1, gamma_ind ind2, char *channel_name, char *channel_type,
                                 double sign) {
...
static void spinmatrix_op(suNf_spin_matrix *out, suNf_spin_matrix *in, gamma_ind i) {
    switch (i) {
    case _g5:
        _spinmatrix_g5(*out, *in);
        break;
    case _id:
        *out = *in;
        break;
    case _g0:
        _spinmatrix_g0(*out, *in);
        break;
    case _g1:
        _spinmatrix_g1(*out, *in);
        break;
    case _g2:
        _spinmatrix_g2(*out, *in);
        break;
    case _g3:
        _spinmatrix_g3(*out, *in);
        break;
    case _g0g1:
        _spinmatrix_g0g1(*out, *in);
        break;
    case _g0g2:
        _spinmatrix_g0g2(*out, *in);
        break;
    case _g0g3:
        _spinmatrix_g0g3(*out, *in);
        break;
    case _g0g5:
        _spinmatrix_g0g5(*out, *in);
        break;
    case _g5g1:
        _spinmatrix_g5g1(*out, *in);
        break;
    case _g5g2:
        _spinmatrix_g5g2(*out, *in);
        break;
    case _g5g3:
        _spinmatrix_g5g3(*out, *in);
        break;
    case _g0g5g1:
        _spinmatrix_g5g0g1(*out, *in);
        break;
    case _g0g5g2:
        _spinmatrix_g5g0g2(*out, *in);
        break;
    case _g0g5g3:
        _spinmatrix_g5g0g3(*out, *in);
        break;
    default:
        break;
    }
...
static void op_spinmatrix(suNf_spin_matrix *out, suNf_spin_matrix *in, gamma_ind i) {
    switch (i) {
    case _g5:
        _g5_spinmatrix(*out, *in);
        break;
    case _id:
        *out = *in;
        break;
    case _g0:
        _g0_spinmatrix(*out, *in);
        break;
    case _g1:
        _g1_spinmatrix(*out, *in);
        break;
    case _g2:
        _g2_spinmatrix(*out, *in);
        break;
    case _g3:
        _g3_spinmatrix(*out, *in);
        break;
    case _g0g1:
        _g0g1_spinmatrix(*out, *in);
        break;
    case _g0g2:
        _g0g2_spinmatrix(*out, *in);
        break;
    case _g0g3:
        _g0g3_spinmatrix(*out, *in);
        break;
    case _g0g5:
        _g0g5_spinmatrix(*out, *in);
        break;
    case _g5g1:
        _g5g1_spinmatrix(*out, *in);
        break;
    case _g5g2:
        _g5g2_spinmatrix(*out, *in);
        break;
    case _g5g3:
        _g5g3_spinmatrix(*out, *in);
        break;
    case _g0g5g1:
        _g5g0g1_spinmatrix(*out, *in);
        break;
    case _g0g5g2:
        _g5g0g2_spinmatrix(*out, *in);
        break;
    case _g0g5g3:
        _g5g0g3_spinmatrix(*out, *in);
        break;
    default:
        break;
    }
...
static void op_propagator(suNf_propagator *out, suNf_propagator *in, gamma_ind i) {
    switch (i) {
    case _g5:
        _g5_propagator((*out), (*in));
        break;
    case _id:
        *out = *in;
        break;
    case _g0:
        _g0_propagator((*out), (*in));
        break;
    case _g1:
        _g1_propagator((*out), (*in));
        break;
    case _g2:
        _g2_propagator((*out), (*in));
        break;
    case _g3:
        _g3_propagator((*out), (*in));
        break;
    default:
        break;
    }
...
#define corr_ind(px, py, pz, n_mom, tc, nm, cm) \
    ((px) * (n_mom) * (n_mom) * (lt) * (nm) + (py) * (n_mom) * (lt) * (nm) + (pz) * (lt) * (nm) + ((cm) * (lt)) + (tc))

/* spinor_fields* are 4xnm arrays of spinor_field ordered([color][spinor])*/
void measure_mesons_core(spinor_field *psi0, spinor_field *psi1, spinor_field *eta, meson_observable *mo, int nm, int tau,
                         int n_mom, int offset, int lt) {
                        ...
                        for (x = 0; x < X; x++) {
                            for (y = 0; y < Y; y++) {
                                for (z = 0; z < Z; z++) {
                                    ...
                                    pdotx =
                                        2.0 * PI *
                                        (((double)px) * (x + zerocoord[1]) / GLB_X + ((double)py) * (y + zerocoord[2]) / GLB_Y +
                                         ((double)pz) * (z + zerocoord[3]) / GLB_Z);
                                    cpdotx = cos(pdotx);
                                    spdotx = sin(pdotx);
                                    ...
                                    while (motmp != NULL) {
                                        ...
                                        motmp->corr_re[corr_ind(px, py, pz, n_mom, tc, nm, i)] +=
                                            motmp->sign * (creal(tr) * cpdotx + cimag(tr) * spdotx);
                                        motmp->corr_im[corr_ind(px, py, pz, n_mom, tc, nm, i)] +=
                                            motmp->sign * (cimag(tr) * cpdotx - creal(tr) * spdotx);
                                        motmp = motmp->next;
                                    }
                                }
                            }
...
static void measure_conserved_core(spinor_field *psi0, spinor_field *psi1, spinor_field *eta, meson_observable *mo, int nm,
                                   int tau, int n_mom, int offset, int lt) {
#ifdef CHECK_SPINOR_MATCHING
                            ...
                            for (y = 0; y < Y; y++) {
                                for (z = 0; z < Z; z++) {
                                    ...
                                    while (motmp != NULL) {
                                        ...
                                        for (a = 0; a < NF; ++a) {
                                            for (beta = 0; beta < 4; beta++) {
                                                _propagator_assign(spf, *_FIELD_AT(&psi0[a * 4 * nm + beta * nm + i], ixmu), a,
                                                                   beta); // S(x+mu, y)
                                            }
                                        }
                                        ...
                                        motmp->corr_re[corr_ind(px, py, pz, n_mom, tc, nm, i)] +=
                                            0.5 * motmp->sign * (creal(tr) * cpdotx + cimag(tr) * spdotx);
                                        motmp->corr_im[corr_ind(px, py, pz, n_mom, tc, nm, i)] +=
                                            0.5 * motmp->sign * (cimag(tr) * cpdotx - creal(tr) * spdotx);
                                        motmp = motmp->next;
...
static void init_corrs(int nm, int n_mom, meson_observable *mo) {
    ...
    if (n_mom >= GLB_X) {
        n_mom = GLB_X - 1;
        lprintf("measure_mesons_with_momenta", 0, "Reduced n_mom to %d (no more momenta accessible with this lattice size) ",
                n_mom);
    }
...
void measure_point_mesons_momenta_ext(meson_observable *mo, spinor_field *psi0, spinor_field *eta, int nm, int tau, int n_mom,
                                      int begin) {
        ...
        for (py = 0; py < n_mom; ++py) {
            for (pz = 0; pz < n_mom; ++pz) {
                for (i = 0; i < nm; i++) {
                    /*Real*/
                    if (n_mom > 1) {
                        lprintf("MAIN", 0, "conf #%d mass=%2.6f %s %s %s_re momentum(%d,%d,%d)= ", conf, mass[i], label,
                                mo->channel_type, mo->channel_name, px, py, pz);
                    } else {
                        if (mo->ind1 == mo->ind2) {
                            lprintf("MAIN", 0, "conf #%d mass=%2.6f %s %s %s= ", conf, mass[i], label, mo->channel_type,
                                    mo->channel_name); // To be compatible with the old output
                        } else {
                            lprintf("MAIN", 0, "conf #%d mass=%2.6f %s %s %s_re= ", conf, mass[i], label, mo->channel_type,
                                    mo->channel_name);
                        }
                    }
                    for (t = 0; t < lt; ++t) {
                    ...
                    /*Imaginary */
                    if (n_mom > 1) {
                        lprintf("MAIN", 0, "conf #%d mass=%2.6f %s %s %s_im momentum(%d,%d,%d)= ", conf, mass[i], label,
                                mo->channel_type, mo->channel_name, px, py, pz);
                    } else {
                        lprintf("MAIN", 0, "conf #%d mass=%2.6f %s %s %s_im= ", conf, mass[i], label, mo->channel_type,
                                mo->channel_name);
                    }
                    for (t = 0; t < lt; ++t) {
