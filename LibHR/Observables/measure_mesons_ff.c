...
static void op_spinor(suNf_spinor *out, suNf_spinor *in, gamma_ind i) {
    ...
    case _g3:
        ...
        break;
    case _g0g1:
        _spinor_g0g1_f(*out, *in);
        break;
    case _g0g2:
        _spinor_g0g2_f(*out, *in);
        break;
    case _g0g3:
        _spinor_g0g3_f(*out, *in);
        break;
    case _g0g5:
        _spinor_g0g5_f(*out, *in);
        break;
    case _g5g1:
        _spinor_g5g1_f(*out, *in);
        break;
    case _g5g2:
        _spinor_g5g2_f(*out, *in);
        break;
    case _g5g3:
        _spinor_g5g3_f(*out, *in);
        break;
    case _g0g5g1:
        _spinor_g5g0g1_f(*out, *in);
        break;
    case _g0g5g2:
        _spinor_g5g0g2_f(*out, *in);
        break;
    case _g0g5g3:
        _spinor_g5g0g3_f(*out, *in);
        break;
    default:
        break;
    }
...
static void measure_mesons_disconnected_core(spinor_field *psi0, spinor_field *psi1, spinor_field *eta, meson_observable *mo,
                                             int offset, int lt) {
    int ix, t, x, y, z, tc;
    hr_complex tr;
