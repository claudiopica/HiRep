...
static inline double complex diPoly_p_0_0_0_Ir_1_C_1_n_1(int x1, int y1, int z1)
{
...
static inline double complex diPoly_p_0_0_0_Ir_3_C_1_n_1(int x1, int y1, int z1)
{
    int idx = ntors * (x1 + X * (y1 + Y * z1));
...
static inline double complex diPoly_p_0_0_0_Ir_3_C_1_n_2(int x1, int y1, int z1)
{
    int idx = ntors * (x1 + X * (y1 + Y * z1));
...
static inline double complex diPoly_p_0_0_0_Ir_4_C_1_n_1(int x1, int y1, int z1)
{
    int idx = ntors * (x1 + X * (y1 + Y * z1));
...
static inline double complex diPoly_p_0_0_0_Ir_4_C_1_n_2(int x1, int y1, int z1)
{
    int idx = ntors * (x1 + X * (y1 + Y * z1));
...
static inline double complex diPoly_p_0_0_0_Ir_4_C_1_n_3(int x1, int y1, int z1)
{
    int idx = ntors * (x1 + X * (y1 + Y * z1));
...
static inline double complex diPoly_p_0_1_0_Ir_1_C_1_n_1(int x1, int y1, int z1)
{
    int idx = ntors * (x1 + X * (y1 + Y * z1));
...
static inline double complex diPoly_p_1_1_1_Ir_1_C_1_n_1(int x1, int y1, int z1)
{
    int idx = ntors * (x1 + X * (y1 + Y * z1));
...
static void eval_time_momentum_torellons(int t, double complex *np, double complex **pf)
{
    ...
    double complex ce = I * 2.0 * 3.141592653589793238462643383279502884197 / GLB_X;
    for (nnx = 0; nnx < X; nnx++)
        for (nny = 0; nny < Y; nny++)
            for (nnz = 0; nnz < Z; nnz++)
            {
...
void eval_all_torellon_ops(int t, double complex *numerical_tor_out, double complex **polyf)
{
