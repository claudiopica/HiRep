...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(SF_var.configlist, "") != 0) {
        error((list = fopen(SF_var.configlist, "r")) == NULL, 1, "main [mk_sfcoupling.c]", "Failed to open list file\n");
    }
...
#endif
    if (strcmp(SF_var.background, "true") == 0) { BCs_pars.SF_BCs = 1; }
