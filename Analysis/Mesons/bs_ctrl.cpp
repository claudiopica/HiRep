...
bool eval_ctrl::fill_dep(const char *arg) {
    ...
    mpcac.dep[D_EFF_B1][0] = &g5;
    mpcac.dep_level[D_EFF_B1][0] = P_COR_B1;
    mpcac.dep[D_EFF_B1][1] = &g5;
    mpcac.dep_level[D_EFF_B1][1] = P_EFF_B1;
    mpcac.dep[D_EFF_B1][2] = &g5_g0g5;
    mpcac.dep_level[D_EFF_B1][2] = P_COR_B1;
    mpcac.set_ndeps(D_EFF_B2, 3);
    mpcac.dep[D_EFF_B2][0] = &g5;
    mpcac.dep_level[D_EFF_B2][0] = P_COR_B2;
    mpcac.dep[D_EFF_B2][1] = &g5;
    mpcac.dep_level[D_EFF_B2][1] = P_EFF_B2;
    mpcac.dep[D_EFF_B2][2] = &g5_g0g5;
    mpcac.dep_level[D_EFF_B2][2] = P_COR_B2;
    mpcac.set_ndeps(D_FIT, 1);
    mpcac.dep[D_FIT][0] = &mpcac;
    mpcac.dep_level[D_FIT][0] = D_EFF_B2;

    gps.set_ndeps(D_EFF_B1, 2);
    gps.dep[D_EFF_B1][0] = &g5;
    gps.dep_level[D_EFF_B1][0] = P_COR_B1;
    gps.dep[D_EFF_B1][1] = &g5;
    gps.dep_level[D_EFF_B1][1] = P_EFF_B1;
    gps.set_ndeps(D_EFF_B2, 2);
    gps.dep[D_EFF_B2][0] = &g5;
    gps.dep_level[D_EFF_B2][0] = P_COR_B2;
    gps.dep[D_EFF_B2][1] = &g5;
    gps.dep_level[D_EFF_B2][1] = P_EFF_B2;
    gps.set_ndeps(D_FIT, 1);
    gps.dep[D_FIT][0] = &gps;
    gps.dep_level[D_FIT][0] = D_EFF_B2;

    fps.set_ndeps(D_EFF_B1, 3);
    fps.dep[D_EFF_B1][0] = &g5;
    fps.dep_level[D_EFF_B1][0] = P_COR_B1;
    fps.dep[D_EFF_B1][1] = &g5;
    fps.dep_level[D_EFF_B1][1] = P_EFF_B1;
    fps.dep[D_EFF_B1][2] = &mpcac;
    fps.dep_level[D_EFF_B1][2] = D_EFF_B1;
    fps.set_ndeps(D_EFF_B2, 3);
    fps.dep[D_EFF_B2][0] = &g5;
    fps.dep_level[D_EFF_B2][0] = P_COR_B2;
    fps.dep[D_EFF_B2][1] = &g5;
    fps.dep_level[D_EFF_B2][1] = P_EFF_B2;
    fps.dep[D_EFF_B2][2] = &mpcac;
    fps.dep_level[D_EFF_B2][2] = D_EFF_B2;
    fps.set_ndeps(D_FIT, 1);
    fps.dep[D_FIT][0] = &fps;
    fps.dep_level[D_FIT][0] = D_EFF_B2;

    fv.set_ndeps(D_EFF_B1, 2);
    fv.dep[D_EFF_B1][0] = &g1;
    fv.dep_level[D_EFF_B1][0] = P_COR_B1;
    fv.dep[D_EFF_B1][1] = &g1;
    fv.dep_level[D_EFF_B1][1] = P_EFF_B1;
    fv.set_ndeps(D_EFF_B2, 2);
    fv.dep[D_EFF_B2][0] = &g1;
    fv.dep_level[D_EFF_B2][0] = P_COR_B2;
    fv.dep[D_EFF_B2][1] = &g1;
    fv.dep_level[D_EFF_B2][1] = P_EFF_B2;
    fv.set_ndeps(D_FIT, 1);
    fv.dep[D_FIT][0] = &fv;
    fv.dep_level[D_FIT][0] = D_EFF_B2;

    fvk.set_ndeps(D_EFF_B1, 2);
    fvk.dep[D_EFF_B1][0] = &gk;
    fvk.dep_level[D_EFF_B1][0] = P_COR_B1;
    fvk.dep[D_EFF_B1][1] = &gk;
    fvk.dep_level[D_EFF_B1][1] = P_EFF_B1;
    fvk.set_ndeps(D_EFF_B2, 2);
    fvk.dep[D_EFF_B2][0] = &gk;
    fvk.dep_level[D_EFF_B2][0] = P_COR_B2;
    fvk.dep[D_EFF_B2][1] = &gk;
    fvk.dep_level[D_EFF_B2][1] = P_EFF_B2;
    fvk.set_ndeps(D_FIT, 1);
    fvk.dep[D_FIT][0] = &fvk;
    fvk.dep_level[D_FIT][0] = D_EFF_B2;

    fak.set_ndeps(D_EFF_B1, 2);
    fak.dep[D_EFF_B1][0] = &g5gk;
    fak.dep_level[D_EFF_B1][0] = P_COR_B1;
    fak.dep[D_EFF_B1][1] = &g5gk;
    fak.dep_level[D_EFF_B1][1] = P_EFF_B1;
    fak.set_ndeps(D_EFF_B2, 2);
    fak.dep[D_EFF_B2][0] = &g5gk;
    fak.dep_level[D_EFF_B2][0] = P_COR_B2;
    fak.dep[D_EFF_B2][1] = &g5gk;
    fak.dep_level[D_EFF_B2][1] = P_EFF_B2;
    fak.set_ndeps(D_FIT, 1);
    fak.dep[D_FIT][0] = &fak;
    fak.dep_level[D_FIT][0] = D_EFF_B2;

    mvmps.set_ndeps(2);
    mvmps.dep[0] = &g5;
    mvmps.dep_level[0] = P_FIT;
    mvmps.dep[1] = &g1;
    mvmps.dep_level[1] = P_FIT;

    mvkmps.set_ndeps(2);
    mvkmps.dep[0] = &g5;
    mvkmps.dep_level[0] = P_FIT;
    mvkmps.dep[1] = &gk;
    mvkmps.dep_level[1] = P_FIT;

    mpsfps.set_ndeps(2);
    mpsfps.dep[0] = &fps;
    mpsfps.dep_level[0] = D_FIT;
    mpsfps.dep[1] = &g5;
    mpsfps.dep_level[1] = P_FIT;

    mvfps.set_ndeps(2);
    mvfps.dep[0] = &fps;
    mvfps.dep_level[0] = D_FIT;
    mvfps.dep[1] = &g1;
    mvfps.dep_level[1] = P_FIT;

    mvkfps.set_ndeps(2);
    mvkfps.dep[0] = &fps;
    mvkfps.dep_level[0] = D_FIT;
    mvkfps.dep[1] = &gk;
    mvkfps.dep_level[1] = P_FIT;

    mpsmpcac.set_ndeps(2);
    mpsmpcac.dep[0] = &mpcac;
    mpsmpcac.dep_level[0] = D_FIT;
    mpsmpcac.dep[1] = &g5;
    mpsmpcac.dep_level[1] = P_FIT;

    mps2mpcac.set_ndeps(2);
    mps2mpcac.dep[0] = &mpcac;
    mps2mpcac.dep_level[0] = D_FIT;
    mps2mpcac.dep[1] = &g5;
    mps2mpcac.dep_level[1] = P_FIT;

    fvfps.set_ndeps(2);
    fvfps.dep[0] = &fps;
    fvfps.dep_level[0] = D_FIT;
    fvfps.dep[1] = &fv;
    fvfps.dep_level[1] = D_FIT;

    fvkfps.set_ndeps(2);
    fvkfps.dep[0] = &fps;
    fvkfps.dep_level[0] = D_FIT;
    fvkfps.dep[1] = &fvk;
    fvkfps.dep_level[1] = D_FIT;

    mamps.set_ndeps(2);
    mamps.dep[0] = &g5;
    mamps.dep_level[0] = P_FIT;
    mamps.dep[1] = &g5g1;
    mamps.dep_level[1] = P_FIT;

    makmps.set_ndeps(2);
    makmps.dep[0] = &g5;
    makmps.dep_level[0] = P_FIT;
    makmps.dep[1] = &g5gk;
    makmps.dep_level[1] = P_FIT;

    mamv.set_ndeps(2);
    mamv.dep[0] = &g1;
    mamv.dep_level[0] = P_FIT;
    mamv.dep[1] = &g5g1;
    mamv.dep_level[1] = P_FIT;

    makmvk.set_ndeps(2);
    makmvk.dep[0] = &gk;
    makmvk.dep_level[0] = P_FIT;
    makmvk.dep[1] = &g5gk;
    makmvk.dep_level[1] = P_FIT;

    gmor.set_ndeps(3);
    gmor.dep[0] = &mpcac;
    gmor.dep_level[0] = D_FIT;
    gmor.dep[1] = &g5;
    gmor.dep_level[1] = P_FIT;
    gmor.dep[2] = &fps;
    gmor.dep_level[2] = D_FIT;

    bool found = false;

    /* CORRELATORS */
#define IF_COR(ch)                                                     \
    if (strcmp(arg, #ch "_cor") == 0 || strcmp(arg, "all_cor") == 0) { \
        ch.set_level(P_AVE_COR);                                       \
        found = true;                                                  \
    }
...
#undef IF_COR
    ...
    /* EFFECTIVE MASSES */
#define IF_EFF(ch)                                                     \
    if (strcmp(arg, #ch "_eff") == 0 || strcmp(arg, "all_eff") == 0) { \
        ch.set_level(P_AVE_EFF);                                       \
        found = true;                                                  \
    }
...
#define IF_FIT(ch)                                              \
    if (strcmp(arg, #ch) == 0 || strcmp(arg, "all_fit") == 0) { \
        ch.set_level(P_AVE_FIT);                                \
        found = true;                                           \
    }
...
#undef IF_FIT
    ...
    /* DERIVED */
#define IF_DER_EFF(ch)                                                     \
    if (strcmp(arg, #ch "_eff") == 0 || strcmp(arg, "all_der_eff") == 0) { \
        ch.set_level(D_AVE_EFF);                                           \
        found = true;                                                      \
    }
...
#define IF_DER_FIT(ch)                                              \
    if (strcmp(arg, #ch) == 0 || strcmp(arg, "all_der_fit") == 0) { \
        ch.set_level(D_AVE_FIT);                                    \
        found = true;                                               \
    }
...
#undef IF_DER_FIT
    ...
    /* RATIOS */
#define IF_RATIO(ch)                                              \
    if (strcmp(arg, #ch) == 0 || strcmp(arg, "all_ratio") == 0) { \
        ch.set_level(R_ACTIVE);                                   \
        found = true;                                             \
    }
...
void eval_ctrl::normalize_cuts(int lt) {
    ...
    for (set<derived_ctrl *>::iterator dctrl_it = derived_ctrl::all_der.begin(); dctrl_it != derived_ctrl::all_der.end();
         dctrl_it++) {
    ...
    for (set<eval_ctrl *>::iterator ctrl_it = eval_ctrl::all.begin(); ctrl_it != eval_ctrl::all.end(); ctrl_it++) {
        if (((*ctrl_it)->isprimary() && ((*ctrl_it)->get_level(P_EFF_B1) || (*ctrl_it)->get_level(P_EFF_B2))) ||
            ...
            if ((*ctrl_it)->get_left_cut() < 0) {
                cerr << "[normalize_cuts] Left cut for " << (*ctrl_it)->name << " less than 0" << endl;
                exit(1);
            }
            if ((*ctrl_it)->get_right_cut() > lt / 2) {
                cerr << "[normalize_cuts] Right cut for " << (*ctrl_it)->name << " greater than " << lt / 2 << endl;
                exit(1);
            }
        }
    }
...
void primary_ctrl::add_channel(const char *c1) {
    ...
    cout << "3 PRIMARY_CTRL add_channel"
         << " name=" << name << " channel[" << chan_counter << "]=" << c1 << endl;
}
        ...
        if (level[k]) {
            for (int i = 0; i < ndep[k]; i++) {
                if ((dep[k][i]->isprimary() && (dep_level[k][i] == P_EFF_B1 || dep_level[k][i] == P_EFF_B2)) ||
                    ...
                    if (left_cut[name] < dep[k][i]->get_left_cut()) { left_cut[name] = dep[k][i]->get_left_cut(); }
                    if (right_cut[name] > dep[k][i]->get_right_cut()) { right_cut[name] = dep[k][i]->get_right_cut(); }
                }
            }
        }
    }
...
ostream &primary_ctrl::print_utility(ostream &os) {
    return os << " P_READ " << level[P_READ] << " P_COR_B1 " << level[P_COR_B1] << " P_EFF_B1 " << level[P_EFF_B1]
              << " P_COR_B2 " << level[P_COR_B2] << " P_EFF_B2 " << level[P_EFF_B2] << " P_FIT " << level[P_FIT]
              << " P_AVE_COR " << level[P_AVE_COR] << " P_AVE_EFF " << level[P_AVE_EFF] << " P_AVE_FIT " << level[P_AVE_FIT];
}

ostream &derived_ctrl::print_utility(ostream &os) {
    return os << " D_EFF_B1 " << level[D_EFF_B1] << " D_EFF_B2 " << level[D_EFF_B2] << " D_FIT " << level[D_FIT]
              << " D_AVE_EFF " << level[D_AVE_EFF] << " D_AVE_FIT " << level[D_AVE_FIT];
}

ostream &ratio_ctrl::print_utility(ostream &os) {
    return os << " R_ACTIVE " << level[R_ACTIVE];
}
    ...
    if (level[P_READ]) {
        if (cor_b0 == NULL) {
            ...
            for (int nc = 0; nc < nchan; nc++) {
                if (channel_map.find(channel[nc]) == channel_map.end()) { channel_map[channel[nc]] = new Corr_t(lt); }
...
void primary_ctrl::print() {
    if (level[P_AVE_COR]) {
        for (int t = 0; t < cor_b1->length; t++) {
            cout << "10 COR " << name << " " << t << " " << cor_b1->d[t].avr().val << " " << cor_b1->d[t].stderr().val
                 << " blksize " << blsize << endl;
        }
    }
    ...
    if (level[P_AVE_EFF]) {
        for (int t = left_cut[name]; t <= right_cut[name]; t++) {
            cout << "10 EFF " << name << " " << t << " " << eff_b1->d[t].avr().val << " " << eff_b1->d[t].stderr().val
                 << " blksize " << blsize << endl;
        }
    }

    if (level[P_AVE_FIT]) {
        cout << "10 FIT " << name << " " << fit.avr().val << " " << fit.stderr().val << " blksize " << blsize << " lcut "
             << left_cut[name] << " rcut " << right_cut[name] << endl;
    }
}
    ...
    if (get_level(P_EFF)) {
        if (effmass_method == 0) {
            for (int i = get_left_cut(); i <= get_right_cut(); i++) {
                ws_eff[i] = plain_eff_mass(Lt / 2 - i, ws_cor[(i - 1 + Lt) % Lt] / ws_cor[i]);
            ...
            int ret;
            for (int i = get_left_cut(); i <= get_right_cut(); i++) {
                ret = shifted_prony_eff_mass_1(ws_cor, i, get_right_cut(), &m1, Lt);
            ...
            int ret;
            for (int i = get_left_cut(); i <= get_right_cut(); i++) {
                ret = shifted_prony_eff_mass_2(ws_cor, i, get_right_cut(), &m1, &m2, Lt);
                if (ret == 0) { return false; }
                ws_eff[i] = m1;
            }
        }
